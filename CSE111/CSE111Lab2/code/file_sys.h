...
class inode_state {
   ...
   public:
      ...
      string getThisDir(){return thisDir;}
      void setThisDir(string newDir){thisDir = newDir;}
...
class base_file {
   ...
   public:
      ...
      virtual void changeFile(bool c) {isFile = c;}
      virtual bool is_file(){return isFile;}
      virtual void printDirents() = 0;
...
class directory: public base_file {
   ...
   public:
      ...
      //need to refer to this getDirents when called on a directory
